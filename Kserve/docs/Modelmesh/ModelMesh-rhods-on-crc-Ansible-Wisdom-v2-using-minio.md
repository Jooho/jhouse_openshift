...
export wisdom_img_tag=wisdom-v2  
export runtime_version=0.0.8  
~~~
...
**Check model size**
~~~
oc exec -it deploy/modelmesh-serving-wisdom-runtime -c puller -- du -h --max-depth=1 /models
~~~
...
sed 's/gpu-version-inference-service-v05/ansible-wisdom-v2/g' -i ./grpcurl.sh
