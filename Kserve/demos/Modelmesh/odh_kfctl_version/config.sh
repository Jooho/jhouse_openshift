...
export MODELMESH_TEST_NS=${ODH_NS}-mm
export DEMO_DIR=/tmp
...
MODELMESH_PROJECT="redhat-ods-applications"
INFERENCE_SERVICE_PROJECT="redhat-ods-applications"
